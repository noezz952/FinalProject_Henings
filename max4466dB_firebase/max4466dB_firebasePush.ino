...
// Sensor settings
const int ledKuning = 32;
const int ledHijau = 33;
const int sampleWindow = 50;    // Sample window width in mS (50 mS = 20Hz)
const int AMP_PIN = 35;         // ADC1 channel 6 on ESP32 (GPIO 34)
const float MIC_SENSITIVITY_dBV = 13.0; // Sensitivity of MAX4466 microphone in dBV (typical value)
...
void loop() {
  ...
  Serial.println(dB);
  String soundLevel = "/soundLevel MAX4466/"; //+ String(urut);
